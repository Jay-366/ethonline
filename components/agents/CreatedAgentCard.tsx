...
export interface CreatedAgentCardProps
...
/**
 * A sophisticated glass-effect card component for created AI agents.
 * Features revenue display, status indicator, and edit functionality.
 */
export const CreatedAgentCard = React.forwardRef<HTMLDivElement, CreatedAgentCardProps>(
  (
    {
      className,
      variant,
