...
export default function FileUpload({ onFilesChange }: FileUploadProps) {
  ...
  const handleFiles = (fileList: FileList) => {
    ...
    setFiles((prev) => {
      ...
      if (onFilesChange) {
        onFilesChange(updated.map(f => f.file).filter((f): f is File => f !== undefined));
      }
      return updated;
    });
            ...
            {files.map((file) => (
              ...
              >
                ...
                <div className="flex-1 min-w-0">
                  ...
                  {/* Progress bar */}
                  <div className="w-full h-2 rounded-full overflow-hidden mt-3" style={{ backgroundColor: '#5d606c' }}>
                    <motion.div
                      initial={{ width: 0 }}
                      ...
                      style={{
                        backgroundColor: file.progress < 100 ? '#f8ede0' : '#f8ede0',
                      }}
                    />
                  </div>
                </div>
